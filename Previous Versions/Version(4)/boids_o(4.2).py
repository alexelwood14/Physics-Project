        ...
        if len(self.detected_boids) != 0:
            ...
            if average_pos[0] != 0.0 and average_pos[1] != 0.0:
                ...
                if self.vel[0] != 0:
                    ...
                    if (average_pos[1] < line_height and self.vel[0] <= 0) or (average_pos[1] > line_height and self.vel[0] >= 0):
                        self.ang_vel += angle
                                    
                    elif (average_pos[1] > line_height and self.vel[0] <= 0) or (average_pos[1] < line_height and self.vel[0] >= 0):
                        self.ang_vel -= angle
