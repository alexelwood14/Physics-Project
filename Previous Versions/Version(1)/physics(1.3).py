...
def simulation(window, clock, colours, resolution, border_inset, dyn_objects, sta_objects, sliders, phy_consts):
    ...
    dyn_objects["sphere"].set_pos([resolution[0]/2, resolution[1]/2])
    dyn_objects["sphere"].set_vel([200.0, 2000.0])
    dyn_objects["sphere2"].set_pos([resolution[0]/4, resolution[1]/2])
    dyn_objects["sphere2"].set_vel([-300.0, -1000.0])
