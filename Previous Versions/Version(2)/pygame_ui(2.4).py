...
class Scroll_Bar():
    ...
    def render(self):
        pygame.draw.rect(self.window, self.colour, [self.pos[0] - 20, self.pos[1] - 500, 40, self.max], 4)
    ...
    def dragging(self):        
        if pygame.mouse.get_pressed()[0]:
            ...
            if (mouse_pos[0] <= self.pos[0] + 40 and mouse_pos[0] >= self.pos[0] and
                mouse_pos[1] <= self.slider_pos + self.slider_size + 40 and mouse_pos[1] >= self.slider_pos + 40) or self.grabbed:
