...
##        boids.append(boids_o.boid(window, colours["red"], boid_size, resolution, vision_range))
    ...
    boids.append(boids_o.boid(window, colours["red"], boid_size, resolution, vision_range, [250.0,250.0]))

    boids.append(boids_o.boid(window, colours["red"], boid_size, resolution, vision_range, [210.0,460.0], 1))
    boids.append(boids_o.boid(window, colours["red"], boid_size, resolution, vision_range, [250.0,500.0]))
##
