...
class Car:
    def __init__(self, window, colours, pos, size):
        ...
        self.wheels = []
        self.wheels.append(
            Wheel(window, colours["grey"], [self.pos[0] - self.size, self.pos[1] - self.size * 1.6], size / 3))
        self.wheels.append(
            Wheel(window, colours["grey"], [self.pos[0] + self.size, self.pos[1] - self.size * 1.6], size / 3))
        self.wheels.append(
            Wheel(window, colours["grey"], [self.pos[0] + self.size, self.pos[1] + self.size * 1.6], size / 3))
    ...
    def dynamics(self, frame_time):
        ...
        if (self.rear_norm[0] * self.front_norm[1] - self.rear_norm[1] * self.front_norm[0]) != 0:
            mu = ((self.rear_norm[0] * (self.rear_axel[1] - self.front_axel[1]) - self.rear_norm[1] * (
                        self.rear_axel[0] - self.front_axel[0]))
        ...
        # Move car geometry away from turning point
        self.points_mat = np.array(
            [[self.points_mat[0][0] - self.turning_point[0], self.points_mat[0][1] - self.turning_point[1]],
        ...
        self.pos = np.array(
            [(self.points_mat[0][0] + self.points_mat[1][0] + self.points_mat[2][0] + self.points_mat[3][0]) / 4,
    ...
    def display_debug(self):
        ...
        pygame.draw.circle(self.window, self.colours["blue"], [int(self.turning_point[0]), int(self.turning_point[1])],
                           3)
